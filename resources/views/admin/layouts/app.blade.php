    ...
    <div class="min-h-screen text-xs font-medium uppercase">
        <div class="flex">
            ...
            <div class="flex-1">
                <!-- Page Heading -->
                <header class="h-16">
                    <div class="py-4 px-8 flex items-start justify-between">
                        <div class="flex gap-2">
                            ...
                            <a href="/" target="__blank">
                                <x-primary-button class="px-1">
                                    <x-img src="{{ asset('/icons/shinkyowa-white.png') }}" alt="company logo"
                                        class="w-6" />
                                </x-primary-button>
                            </a>
                        </div>
                        <div x-data="{ open: false }" class="relative flex gap-4 items-end">
                            ...
                            <div class="flex flex-col gap-2 items-end">
                                ...
                                <div class="divide-gray-100 divide-y absolute mt-12 right-0 w-48 bg-white border border-gray-200 rounded-lg"
                                ...
                                @if (Auth::check() && Auth::user()->hasRole('customer'))
                                    <p class="text-xs uppercase">Welcome To Shinkyowa</p>
                                @endif
                            </div>
                        </div>
                    </div>
